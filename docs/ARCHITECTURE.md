...
核对基线：v0.0.8。本文由原 LAUNCHER_V1.md 整理而来。开发约束以根目录 [AGENTS.md](../AGENTS.md) 为入口；调用协议见 [IPC_CONTRACTS.md](IPC_CONTRACTS.md)，发布见 [RELEASING.md](RELEASING.md)。文中约束与当前实现差距见 [TODO](../TODO.md)，附属清理仍是 [待实施方案](INSTANCE_CLEANUP_PLAN.md)。

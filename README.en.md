...
![version](https://img.shields.io/badge/version-0.0.8-8b5cf6)
...
- **Installer**: download the [Windows installer](https://github.com/baihejiangnan/deepseek-harness-desktop/releases/download/v0.0.8/DSH.Launcher_0.0.8_x64-setup.exe), install, and launch from the Start menu or desktop shortcut.
- **Portable (Windows x64)**: download the [Windows portable executable](https://github.com/baihejiangnan/deepseek-harness-desktop/releases/download/v0.0.8/DSH-Launcher_0.0.8_windows_x64_portable.exe) and double-click to run — no installation required.
...
The installer lands in `src-tauri/target/release/bundle/nsis/`. The portable Windows exe (double-click to run, no installation required) is available from the [v0.0.8 Release](https://github.com/baihejiangnan/deepseek-harness-desktop/releases/tag/v0.0.8). Development details: [docs/DEVELOPMENT.md](docs/DEVELOPMENT.md).

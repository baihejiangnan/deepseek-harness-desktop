...
pub fn handler() -> impl Fn(Invoke<Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        crate::bridge::cmd::cancel_instance_export,
        ...
        crate::bridge::cmd::rename_provider_template,
        crate::bridge::cmd::get_provider_protocols,
        crate::bridge::cmd::list_runtime_catalog,
        crate::bridge::cmd::get_runtime_catalog_models,
        crate::bridge::cmd::read_instance_providers,
        crate::bridge::cmd::read_instance_credential_roles,
        crate::bridge::cmd::plan_instance_provider_change,
        crate::bridge::cmd::apply_instance_provider_change,
